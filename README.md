...
Data contains a sample metabolomics dataset for the use in the example code. The data comes from this study: https://www.ebi.ac.uk/metabolights/editor/MTBLS1/overview [1] (R. Salek, J. Griffin, A metabolomic study of urinary changes in type 2 diabetes in human compared to the control group
